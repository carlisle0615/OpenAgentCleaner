...
| ------------------------------------ | -------------------- | --------------------------------------------- |
| Push local `main` commit and sync with remote main | Completed (verified) | `docs/current-plans/git-push-main-sync.md` |
...
- This page is an index only; do not expand detailed todos here
- Each parallel task should use its own `docs/current-plans/*.md`
- After task completion, add a `docs/handoffs/*.md` file only when async continuation or risk tracking is actually needed
